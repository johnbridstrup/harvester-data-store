...
echo "CALL sqs_client --queue $URL --destination $DEST --delete --headers $HEADERS --prom-port ${2}"

sqs_client --queue $URL --destination $DEST --delete --headers "$HEADERS" --prom-port ${2}