...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='event.picksession')),
        ...
        migrations.AddField(
            ...
            name='tags',
            field=taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='event.PickSessionTag', to='taggit.Tag', verbose_name='Tags'),
        ),
        migrations.AddIndex(
            model_name='picksession',
