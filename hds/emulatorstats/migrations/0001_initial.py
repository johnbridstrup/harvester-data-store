    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detection_success_percentage', models.FloatField(blank=True, null=True)),
                ...
                ('pick_session', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='event.picksession')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content_object', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='emulatorstats.emustatsreport')),
        ...
        migrations.AddField(
            ...
            name='tags',
            field=taggit.managers.TaggableManager(help_text='A comma-separated list of tags.', through='emulatorstats.EmustatsTag', to='taggit.Tag', verbose_name='Tags'),
        ),
    ]
