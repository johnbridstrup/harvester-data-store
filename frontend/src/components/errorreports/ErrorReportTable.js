...
import { HarvesterHover } from "./ErrorHelpers";
          ...
          <tbody className="report-tbody">
            {reports.map((report, index) => (
              <tr key={index} onClick={() => navigateToDetail(report.reportId)}>
                ...
                <Td onMouseEnter={(e) => handleOnMouseEnter(e, index, 'harvester', report.harvester)} onMouseLeave={handleOnMouseLeave}>{report.harvester.harv_id} { hovering.harvester === index && <HarvesterHover harvester={report.harvester} />}</Td>
